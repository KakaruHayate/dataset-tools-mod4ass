...
## 作用
本仓库程序作用为[Diffsinger(OpenVPI)][https://github.com/openvpi/DiffSinger]的[数据集制作工具][https://github.com/openvpi/dataset-tools]工作流加入[Aegisub][https://aegi.vmoe.info/]作为优化，从而解决以下问题
